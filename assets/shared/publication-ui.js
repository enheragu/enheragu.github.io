(function () {
  ...
  function classMap(variant) {
    if (variant === 'related') {
      return {
        link: 'related-work-inline-link',
        cite: 'related-work-cite',
        summary: 'related-work-cite-summary related-work-inline-link',
        ...
        close: 'related-work-cite-close related-work-inline-link shared-icon-btn',
        section: 'related-work-cite-format',
        sectionTitle: 'related-work-cite-format-title',
        contentWrap: 'related-work-cite-content-wrap',
        copy: 'related-work-cite-copy related-work-inline-link shared-icon-btn',
