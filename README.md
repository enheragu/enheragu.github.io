# enheragu_github_web_cv

Static personal website and research portfolio built with Jekyll.

It includes:

- CV and academic profile pages,
- research and project pages,
- personal and gallery sections,
- shared assets used by linked web tools,
- responsive navigation and GitHub Pages deployment.

Shared assets currently include:

- `assets/shared/controls.css` (theme + language + segmented controls),
