(function () {
  ...
  Branch.prototype.commit = function (options) {
    ...
    if (commit.detail !== null && _isVertical(this.parent)) {
      ...
      var detailSpace = commit.detail.clientHeight + 20; // extra margin after panel
  ...
  Commit.prototype.render = function () {
    ...
    if (this.messageDisplay) {
      ...
      if (this.type === "mergeCommit") {
        this.context.fillText(message, this.x + this.dotSize + 8, this.y + this.dotSize / 2);
      } else {
        this.context.fillText(message, this.x + this.dotSize + 25, this.y + this.dotSize / 2);
      }
    }
  };
